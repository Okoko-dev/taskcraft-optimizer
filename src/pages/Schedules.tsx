    ...
    <div className="min-h-screen bg-taskace-dark text-white pb-24">
      ...
      <main className="p-4 max-w-lg mx-auto">
        ...
        <Tabs defaultValue="today" value={activeTab} onValueChange={setActiveTab} className="mb-6">
          <TabsList className="w-full grid grid-cols-2 bg-taskace-card">
                  ...
                  {scheduledTasks.map((scheduledTask, index) => (
                    <div key={index} className="task-card">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-xs bg-opacity-20 bg-blue-500 text-blue-400 px-2 py-1 rounded-full">
          ...
          <TabsContent value="all" className="mt-4">
            <div className="space-y-4">
              {schedules.map(schedule => (
                <div 
                  key={schedule.id} 
                  className={`p-4 rounded-lg ${currentSchedule?.id === schedule.id ? 'bg-primary/20' : 'bg-taskace-card'} flex justify-between items-center`}
                >
                  <div 
                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-48 bg-taskace-dark border-gray-700 text-white">
                      <div className="space-y-1">
                        ...
                        <Button 
                          variant="ghost" 
                          className="w-full justify-start text-left text-red-500 hover:text-red-400 hover:bg-red-500/10"
                        >
      ...
      <div className="fixed right-6 bottom-24">
        <Button 
          className="w-14 h-14 rounded-full bg-primary hover:bg-primary-dark"
          ...
          <div className="space-y-4 mt-4">
            <div>
              ...
              <Input
                ...
                className="bg-taskace-gray border-gray-700 text-white"
              />
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="text-xs border-gray-700 text-primary"
              ...
              <div className="space-y-3 max-h-60 overflow-y-auto pr-2">
                {scheduleItems.map((item, index) => (
                  <div key={item.id} className="bg-taskace-gray p-3 rounded-lg space-y-2">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div>
              ...
              <Textarea
                ...
                className="bg-taskace-gray border-gray-700 text-white h-20 resize-none"
              />
            </div>
